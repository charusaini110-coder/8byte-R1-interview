...
This repository contains the Infrastructure as Code (IaC) and CI/CD pipelines for deploying a containerized Python-based LLM Routing Service to AWS. The architecture is explicitly designed to maximize efficiency and maintain enterprise-grade security practices while strictly operating within the AWS Free Tier limits.
